...
export default function DashboardStoreProvider({ children }) {
  const [Data, setData] = useState([
    { title: "Room 1", topic: "iothomeroomlight1", type: "light", state: false },
    { title: "Room 2", topic: "iothomeroomlight2", type: "light", state: false },
    { title: "Room 3", topic: "iothomeroomlight3", type: "light", state: false },
    { title: "Room 4", topic: "iothomeroomlight4", type: "light", state: false },
    { title: "Room 5", topic: "iothomeroomlight5", type: "light", state: false },
    { title: "Room 6", topic: "iothomeroomlight6", type: "light", state: false },
    { title: "Room 7", topic: "iothomeroomlight7", type: "light", state: false },
    { title: "Room 8", topic: "iothomeroomlight8", type: "light", state: false },
  ]);
